...
public class InterAccountTransferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner1 = (Spinner) findViewById(R.id.inter_account_transfer_account_1);
        spinner2 = (Spinner) findViewById(R.id.inter_account_transfer_account_2);
        interBankTransferAmount = (EditText) findViewById(R.id.inter_account_transfer_amount);
        spinner1.setAdapter(arrayAdapter);
        spinner2.setAdapter(arrayAdapter);
        Button interBankTransferButton = (Button) findViewById(R.id.inter_account_transfer_button);
        interBankTransferButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (spinner1.getSelectedItem() == null) {
                    ...
                    if (transactionListInstance.addTransaction(fromAccount, amount, false, "Being Amount transferred to " + toAccount.accountName + " Account") == true) {
                        transactionListInstance.addTransaction(toAccount, amount, true, "Being Amount transferred from " + fromAccount.accountName + " Account");
